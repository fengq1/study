package com.fenq1.study.video.jcv.ffmpeg;
...
import com.fenq1.study.video.jcv.exception.CodecNotFoundExpception;
import com.fenq1.study.video.jcv.exception.FileNotOpenException;
import com.fenq1.study.video.jcv.exception.StreamInfoNotFoundException;
import com.fenq1.study.video.jcv.exception.StreamNotFoundException;
import com.fenq1.study.video.jcv.interfaces.Grabber;
...
//			AVCodecContext pCodecCtx = stream.codec();
    ...
    protected AVCodecContext findAndOpenCodec(AVFormatContext formatCtx, int videoStreamIndex) {
        ...
        if (avcodec_parameters_to_context(codecCtx, codecParameters) < 0) {
            log.error("Could not convert parameter to codecContext!");
    ...
    private boolean initGrabber(String url, int fmt) {
        ...
        //scaling/conversion operations by using sws_scale().8
